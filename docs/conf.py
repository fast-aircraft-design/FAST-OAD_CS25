...
def run_apidoc(_):
    ...
    module = os.path.join(cur_dir, "..", "src", "fastoad_cs25")
...
project = "FAST-OAD_CS25"
copyright = "2022, ONERA & ISAE-SUPAERO"
...
exclude_patterns = [
    ...
    "api/*.tests.*",
    "api/*.resources.rst",
    "api/fastoad_cs25.notebooks.*rst",
]
...
try:
    from fastoad_cs25 import __version__
except ImportError:
    pass
else:
