...
@oad.RegisterSubmodel(SERVICE_MLW_MZFW, "fastoad.submodel.weight.mass.mlw_mzfw.analytical")
class UpdateMLWandMZFWanalytical(ExplicitComponent):
    """
    Computes Maximum Landing Weight and Maximum Zero Fuel Weight from
    max payload, reserve fuel weight and diversion fuel weight
