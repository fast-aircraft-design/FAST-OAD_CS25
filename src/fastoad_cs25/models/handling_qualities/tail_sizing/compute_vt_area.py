...
class ComputeVTArea(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:aerodynamics:fuselage:high_speed:CnBeta", val=np.nan, units="1/rad")
        self.add_input(
        ...
        self.add_output("data:aerodynamics:vertical_tail:high_speed:CnBeta", units="1/rad")
