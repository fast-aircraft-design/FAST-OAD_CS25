...
def test_compute_static_margin(input_xml):
    ...
    input_vars.add_output("data:weight:aircraft:CG:aft:MAC_position", 0.438971, units="unitless")
    input_vars.add_output("data:aerodynamics:high_speed:neutral_point:x", 0.537521, units="unitless")
