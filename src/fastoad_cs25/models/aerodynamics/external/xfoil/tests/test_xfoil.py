...
def test_compute(xfoil_path):
    ...
    ivc = IndepVarComp()
    ivc.add_output("xfoil:reynolds", 18000000, units="unitless")
    ivc.add_output("xfoil:mach", 0.20, units="unitless")
    ivc.add_output("data:geometry:wing:thickness_ratio", 0.1284, units="unitless")
