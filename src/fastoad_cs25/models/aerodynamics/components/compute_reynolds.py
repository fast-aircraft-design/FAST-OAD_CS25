...
class ComputeReynolds(ExplicitComponent):
    ...
    def setup(self):
        if self.options["low_speed_aero"]:
            ...
            self.add_output("data:aerodynamics:wing:low_speed:reynolds", units="unitless")
        else:
            ...
            self.add_output("data:aerodynamics:wing:high_speed:reynolds", units="unitless")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if self.options["low_speed_aero"]:
            ...
            outputs["data:aerodynamics:wing:high_speed:reynolds"] = reynolds
