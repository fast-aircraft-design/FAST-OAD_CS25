...
class CdCompressibility(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            "data:aerodynamics:aircraft:high_speed:CL", shape_by_conn=True, val=np.nan, units="unitless"
        )
        ...
        self.add_input(
            "tuning:aerodynamics:aircraft:high_speed:CD:compressibility:max_value",
            val=0.5,
            units="unitless",
