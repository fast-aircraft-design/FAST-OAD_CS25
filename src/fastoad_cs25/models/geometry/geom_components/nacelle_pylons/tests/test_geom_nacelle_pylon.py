...
def test_geometry_nacelle_pylons():
    ...
    input_vars.add_output("data:geometry:fuselage:length", 37.507, units=None)
    ...
    input_vars.add_output("data:geometry:propulsion:engine:y_ratio", 0.34, units=None)
    ...
    input_vars.add_output("data:propulsion:MTO_thrust", 117880.0, units=None)
